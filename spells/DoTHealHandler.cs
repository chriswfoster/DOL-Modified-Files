...
namespace DOL.GS.Spells
{
	...
	/// </summary>
    [SpellHandlerAttribute("LifedrainDamageOverTime")]
	public class DoTHealHandler : SpellHandler
	{
		/// <summary>
		...
		// constructor
		public DoTHealHandler(GameLiving caster, Spell spell, SpellLine line) : base(caster, spell, line) { }
	}
}
