...
namespace DOL.GS.Scripts
{
    ...
    public class BPMob : GameNPC
    {
...

        {
            ...
            if (Level == 45) { basebp = 25; }
            if (Level == 46) { basebp = 30; }
            if (Level == 47) { basebp = 35; }
            if (Level == 48) { basebp = 40; }
            if (Level == 49) { basebp = 45; }
            if (Level == 50) { basebp = 50; }
            if (Level == 51) { basebp = 55; }
            if (Level == 52) { basebp = 60; }
            if (Level == 53) { basebp = 65; }
            if (Level == 54) { basebp = 70; }
            if (Level == 55) { basebp = 90; }
            if (Level >= 56) { basebp = 120; }
            if (Level >= 59) { basebp = 160; }
...

            {
                ...
                if (player.PlayerGroup != null)
                {
                    ...
                    if (player.PlayerGroup.PlayerCount == 1) { rewardbp = (rewardbp); }
                    if (player.PlayerGroup.PlayerCount == 2) { rewardbp = (rewardbp / 2); }
                    if (player.PlayerGroup.PlayerCount == 3) { rewardbp = (rewardbp / 3); }
                    if (player.PlayerGroup.PlayerCount == 4) { rewardbp = (rewardbp / 4); }
                    if (player.PlayerGroup.PlayerCount == 5) { rewardbp = (rewardbp / 5); }
                    if (player.PlayerGroup.PlayerCount == 6) { rewardbp = (rewardbp / 6); }
                    if (player.PlayerGroup.PlayerCount == 7) { rewardbp = (rewardbp / 7); }
                    if (player.PlayerGroup.PlayerCount >= 8) { rewardbp = (rewardbp / 8); }



                    foreach (GamePlayer player2 in player.PlayerGroup)
                    {
