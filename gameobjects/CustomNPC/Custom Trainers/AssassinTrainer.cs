...
namespace DOL.GS
{
    ...
    public class AssassinTrainer : GameNPC
    {


        protected int targetClassID = 69;                                  /// CHANGE THIS!!!
        protected string targetClassName = "assassin";                     ///  CHANGE THIS
        protected string targetClassDescription = "The assassin class is your average stealther class. He'll have hard hitting styles that'll greatly depend on stealth. He'll also have access to bow spec.";
        protected int targetClassRace1 = 12;
        protected int targetClassRace2 = 8;
