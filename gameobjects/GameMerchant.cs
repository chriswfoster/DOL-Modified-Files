 ...
 */
    ...
    public class GameLargeGoldenDiscMerchant : GameItemCurrencyMerchant
    {
        public GameLargeGoldenDiscMerchant()
            : base()
        {
            m_moneyItem = WorldInventoryItem.CreateFromTemplate("Large_Golden_disc");
        }
    }
