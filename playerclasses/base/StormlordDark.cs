...
namespace DOL.GS.PlayerClass
{
    ...
    /// </summary>
    [CharacterClassAttribute((int)eCharacterClass.StormlordDark, "Stormlord of Dark", "Stormlord of Dark")]
    public class StormlordDark : CharacterClassBase
    {
        // private static readonly string[] AutotrainableSkills = new[] {  };
        public StormlordDark()
            : base()
        {
