...
namespace DOL.GS.PlayerClass
{
    ...
    /// </summary>
    [CharacterClassAttribute((int)eCharacterClass.StormlordLight, "Stormlord of Light", "Stormlord of Light")]
    public class StormlordLight : CharacterClassBase
    {
        // private static readonly string[] AutotrainableSkills = new[] {  };
        public StormlordLight()
            : base()
        {
